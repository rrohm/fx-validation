...
import de.aeoniumsystems.fx.validation.annotations.FXValidationChecked;
...
public class FXValidatorService {
  ...
  public static final String DEFAULT_STYLESHEET = "/de/aeoniumsystems/fx/validation/styles/fx-validation.css";
